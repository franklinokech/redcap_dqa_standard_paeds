...
# Purpose: Minimal processing of raw paeds REDCap data for DQA.
...
# Path configuration
RAW_DATA_PATH <- here::here("cin_paeds", "data", "raw", "paeds_data.csv")
PROCESSED_DIR <- here::here("cin_paeds", "data", "processed")
...
run_processing_pipeline <- function(
  ...
  message(strrep("=", 60))
  message("CIN Paediatrics - DATA PROCESSING PIPELINE")
